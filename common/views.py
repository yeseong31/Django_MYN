...
from common.serializers import SigninSerializer, ProfileSerializer, RegisterSerializer
...
class CheckEmailView(generics.GenericAPIView):
    ...
    def post(self, request):
        ...
        return Response({'message': '해당 아이디와 이메일로 인증을 수행할 수 없습니다.'}, status=status.HTTP_400_BAD_REQUEST)
